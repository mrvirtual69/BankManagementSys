...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-9040");
        ...
        c7 = new JCheckBox("I Hereby declares that the above information are correct to the best of my knowledge.");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String cardNumber = "" + Math.abs((random.nextLong() % 900000000000L) + 4622000000000000L);
            ...
            try {
                ...
                if (accountType == null || accountType.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please Check Atleast One Service");
